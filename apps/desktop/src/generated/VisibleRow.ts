 ...
 */
export type VisibleRow = "FocusedHeader" | "HopperHeader" | { "SpaceHeader": string } | { "RepoHeader": string } | { "KindHeader": WorkspaceKind } | { "Workspace": SessionKey } | { "Session": { workspace: SessionKey, session_id: SessionId, } } | { "EpicHeader": string };
