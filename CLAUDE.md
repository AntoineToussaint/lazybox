...
cursor also opens on **right-click** or an **Alt/Ctrl/Cmd + left-click**
...
menu), so it's the reliable mouse path; both need capture on, while
`]]u` works even with capture off. `]]f`
