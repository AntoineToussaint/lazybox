...
mod inspect;
pub use inspect::{
    BUILD_DIR, BUILD_OUTPUT_DIRS, DiffFile, DiffHunk, DiffLine, DiffLineKind, DirtyState,
    DiscoveredCheckout, OrphanReason, SHARED_MAIN_DIR, TrackedSession, WorktreeDiff,
    WorktreeInspection, describe_checkout_at, inspect_worktree_diff, scan_external_checkouts,
