...
/// stats rollup sums (#1621). Optional like [`ModeResolver`]: absent means
/// nothing is reporting, which is the shape before the stats readout.
...
impl Default for SessionState {
    fn default() -> Self {
        Self {
            ...
            disabled: false,
            rewriting: false,
            condensed_ids: std::collections::HashSet::new(),
            saved_bytes: 0,
            saved_micros: 0,
            rewrote: false,
            baseline_share: None,
