...
pub mod SelectionGestureEventOption {
    ...
    pub const GHOSTTY_SELECTION_GESTURE_EVENT_OPT_REF: Type = 0;
    #[doc = " Surface-space pointer position: GhosttySurfacePosition*.\n\n Valid for PRESS, DRAG, and AUTOSCROLL_TICK."]
    pub const GHOSTTY_SELECTION_GESTURE_EVENT_OPT_POSITION: Type = 1;
    #[doc = " Maximum repeat-click distance in pixels: double*."]
    pub const GHOSTTY_SELECTION_GESTURE_EVENT_OPT_REPEAT_DISTANCE: Type = 2;
    ...
    pub const GHOSTTY_SELECTION_GESTURE_EVENT_OPT_TIME_NS: Type = 3;
    #[doc = " Maximum interval between repeat clicks in nanoseconds: uint64_t*."]
    pub const GHOSTTY_SELECTION_GESTURE_EVENT_OPT_REPEAT_INTERVAL_NS: Type = 4;
    ...
    pub const GHOSTTY_SELECTION_GESTURE_EVENT_OPT_WORD_BOUNDARY_CODEPOINTS: Type = 5;
    ...
    pub const GHOSTTY_SELECTION_GESTURE_EVENT_OPT_BEHAVIORS: Type = 6;
    #[doc = " Whether a drag or autoscroll tick should produce a rectangular selection: bool*."]
    pub const GHOSTTY_SELECTION_GESTURE_EVENT_OPT_RECTANGLE: Type = 7;
    #[doc = " Drag display geometry: GhosttySelectionGestureGeometry*. Required for DRAG and AUTOSCROLL_TICK."]
    pub const GHOSTTY_SELECTION_GESTURE_EVENT_OPT_GEOMETRY: Type = 8;
    #[doc = " Viewport coordinate for an autoscroll tick: GhosttyPointCoordinate*. Required for AUTOSCROLL_TICK."]
    pub const GHOSTTY_SELECTION_GESTURE_EVENT_OPT_VIEWPORT: Type = 9;
    #[doc = " Viewport coordinate for an autoscroll tick: GhosttyPointCoordinate*. Required for AUTOSCROLL_TICK."]
    pub const GHOSTTY_SELECTION_GESTURE_EVENT_OPT_MAX_VALUE: Type = 2147483647;
}
unsafe extern "C" {
