...
mod tests {
    ...
    #[allow(
        dead_code,
        reason = "kept for the drift-from-vt.h check; the matching test is gated with #[ignore] because the vendored bindings are intentionally older than the upstream header"
    )]
